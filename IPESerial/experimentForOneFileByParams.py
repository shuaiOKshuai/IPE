...
import interactiveGRUProcessAndAssess
import time
import subprocess
...
if __name__=='__main__':
    ...
    subpaths_file=cf.get("param", "subpaths_file") # # sub-paths file 
    sequences_map=None # the map to store sequences
    sequences_file=cf.get("param", "sequences_file") # # the sequences file 
    ...
    child = subprocess.Popen("nohup python experimentForOneFileByParams2.py &",shell=True)
    ...
    computeFunc=interactiveGRUProcessAndAssess.get_interactiveGRUModel(
        saveto, 
        word_dimension, 
        type_dimension, 
        dimension, 
    ...
    MAP,MnDCG=interactiveGRUProcessAndAssess.compute_path2vec(
        wordsEmbeddings, 
        wordsEmbeddings_path, 
        typesEmbeddings, 
        typesEmbeddings_path, 
